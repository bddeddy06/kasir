              ...
              <div class="row">
                  <div class="col-lg-12 main-chart">
						...
						<div class="col-sm-12">
							<div class="panel panel-primary">
								<div class="panel-heading">
									<h4><i class="fa fa-shopping-cart"></i> Barang Keluar
										...
										<table class="table table-stripped">
											...
											<form method="POST" action="index.php?page=jual&nota=yes#kasirnya">
												...
												<tr>
													...
													<td><button class="btn btn-success"><i class="fa fa-shopping-cart"></i> Proses</button>
													<td>
													...
													<!-- <td>Bayar  </td> -->
													<td><input type="hidden" class="form-control" name="bayar"
											...
											<tr>
												<!-- <td>Kembali</td> -->
												<td><input type="hidden" class="form-control" value="<?php echo $hitung;?>"></td>
												<td></td>
												<!-- <td>
													<a href="print.php?nm_member=<?php echo $_SESSION['admin']['nm_member'];?>
													&bayar=<?php echo $bayar;?>&kembali=<?php echo $hitung;?>" target="_blank">
